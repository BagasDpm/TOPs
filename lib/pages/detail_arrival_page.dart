...
class DetailArrivalPage extends StatefulWidget {
  final int index;
  DetailArrivalPage({
    required this.index,
    super.key,
  ...
  @override
  State<DetailArrivalPage> createState() => _DetailArrivalPageState();
}

class _DetailArrivalPageState extends State<DetailArrivalPage> {
  int _currentSize = 0;
          ...
          ListView(
            ...
            children: [
              Container(
                ...
                child: Image.asset(
                  listDataArrival[widget.index].image,
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      listDataArrival[widget.index].nameBrand,
                      style: TextStyle(
                        fontSize: 24,
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        listDataArrival[widget.index].descBrand,
                        style: TextStyle(
                          fontSize: 18,
                    ...
                    Padding(
                      ...
                      child: Text(
                        textAlign: TextAlign.center,
                        listDataArrival[widget.index].descDetailBrand,
                        style: TextStyle(
                          fontSize: 14,
                          color: Color.fromARGB(255, 147, 147, 147),
                        ),
                    ...
                    children: [
                      ...
                      Text(
                        CurrencyFormat.convertToIdr(
                          int.parse(listDataArrival[widget.index].price),
                          0,
                        ),
                        style: TextStyle(
